...
import network.elrond.crypto.params.DHParameters;
import network.elrond.crypto.params.DHValidationParameters;
import network.elrond.crypto.params.DSAParameters;
import network.elrond.crypto.params.DSAValidationParameters;
