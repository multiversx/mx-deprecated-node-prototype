...
public interface BlockchainService {
    ...
    <H extends Object, B extends Serializable> B get(H hash, Blockchain blockchain, BlockchainUnitType type, boolean fromAllShards) throws IOException, ClassNotFoundException;
