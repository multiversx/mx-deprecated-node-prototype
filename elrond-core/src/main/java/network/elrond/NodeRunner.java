...
public class NodeRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int nb = rand.nextInt(127);
        String nodeName = "elrond-node-2.2" + nb;
        Integer port = 4001 + nb;
        Integer masterPeerPort = 4000;
        String masterPeerIpAddress = "127.0.0.1";
        String nodeRunnerPrivateKey = "1111111111221111fa612ecafcfd145cc06c1fb64d7499ef34696ff16b82" + Util.byteArrayToHexString(new byte[]{new Integer(nb).byteValue()});
        //Reuploaded
