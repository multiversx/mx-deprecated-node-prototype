...
public class SynchronizationRequirement {
    boolean syncRequired;
    BigInteger localBlockIndex;
    BigInteger remoteBlockIndex;

    public SynchronizationRequirement(){
        syncRequired = false;
        localBlockIndex = BigInteger.valueOf(-1);
        remoteBlockIndex = BigInteger.valueOf(-1);
    }

    public SynchronizationRequirement(boolean syncRequired, BigInteger localBlockIndex, BigInteger remoteBlockIndex){
