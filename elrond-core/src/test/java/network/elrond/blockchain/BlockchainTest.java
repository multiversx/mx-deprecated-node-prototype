...
public class BlockchainTest extends BaseBlockchainTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testSetCurrentBlockWithNullShouldThrowException() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testSetGenesisBlockWithNullShouldThrowException() {
        blockchain.setGenesisBlock(null);
    }

    @Test
    public void testSetGenesisBlock() {
        Block block = mock(Block.class);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testSetCurrentBlockIndexWithNullShouldThrowException() {
        blockchain.setCurrentBlockIndex(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testSetCurrentBlockIndexWithNegativeShouldThrowException() {
        blockchain.setCurrentBlockIndex(BigInteger.valueOf(-2));
    }

    @Test
    public void testSetCurrentBlockIndex() {
