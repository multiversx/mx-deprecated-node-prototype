...
//    }
    ...
    public void testComposeBlockWithNullTransactionListShouldThrowException() throws Exception {
        Pair<Block, List<Receipt>> blockReceiptsPair = appBlockManager.composeBlock(null, state);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testComposeBlockWithNullApplicationShouldThrowException() throws Exception {
        Pair<Block, List<Receipt>> blockReceiptsPair = appBlockManager.composeBlock(Arrays.asList(), null);
    }

    @Test
    public void testComposeBlockWithZeroTransaction() throws Exception {
